...
const BRANDS = {
  TDN: {
    ...
    logoTargetH: 116 // 300 / (160/62) — target W=300
  },
  KP: {
  ...
  PS: {
    ...
    logoTargetH: 109 // 150 / (210/153) — target W=150
  }
};

// ----- MAPPING photo source -----
const PHOTO_MAP = {
  yann: '110', jacques: '64', clement: '70', florian: '90',
  anne: '49', veronique: '41',
  sonia: '19', eulalie: '28', sidonie: '57',
  alexandre: '74'
};
...
function wrapStandalone(variants, title) {
  ...
  const buildSection = (isLight, isFirst) => {
    ...
    const textColor = isLight ? '#666' : '#bbb';
    const subLabelColor = isLight ? '#1a1a1a' : '#fff';
    const bgLabel = isLight ? 'fond clair' : 'fond sombre';
